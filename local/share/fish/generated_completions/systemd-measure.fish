...
complete -c systemd-measure -l linux -l osrel -l cmdline -l initrd -l splash -l dtb -l uname -l sbat -l pcrpkey -d 'When used with the calculate or sign verb, configures the files to read the u…'
