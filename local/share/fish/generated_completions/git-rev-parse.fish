# git-rev-parse
# Autogenerated from man page /run/current-system/sw/share/man/man1/git-rev-parse.1.gz
...
complete -c git-rev-parse -l help-all -d 'as documented in gitcli(7).  oc o 2'
