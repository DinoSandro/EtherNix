# git-cherry-pick
# Autogenerated from man page /run/current-system/sw/share/man/man1/git-cherry-pick.1.gz
...
complete -c git-cherry-pick -l continue -d 'Continue the operation in progress using the information in . git/sequencer'
complete -c git-cherry-pick -l skip -d 'Skip the current commit and continue with the rest of the sequence'
complete -c git-cherry-pick -l quit -d 'Forget about the current operation in progress'
complete -c git-cherry-pick -l abort -d 'Cancel the operation and return to the pre-sequence state'
