...
complete -c rdma -s j -l json -d 'Generate JSON output'
complete -c rdma -s o -o oneline -d 'output each record on a single line, replacing line feeds with the  \'\' charac…'
