# git-notes
# Autogenerated from man page /run/current-system/sw/share/man/man1/git-notes.1.gz
...
complete -c git-notes -l notes -d 'option accepted by those commands.  The effective value of "core'
