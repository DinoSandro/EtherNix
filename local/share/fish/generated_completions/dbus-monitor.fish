# dbus-monitor
# Autogenerated from man page /run/current-system/sw/share/man/man1/dbus-monitor.1.gz
...
complete -c dbus-monitor -l pcap -d 'If no mode is specified, dbus-monitor uses the monitoring output format'
