...
complete -c systemd-nspawn -s j -d 'Equivalent to --link-journal=try-guest. sp Added in version 187'
...
complete -c systemd-nspawn -l pipe -s P -d 'Equivalent to --console=pipe. sp Added in version 242'
