# grub-install
# Autogenerated from man page /run/current-system/sw/share/man/man8/grub-install.8.gz
...
complete -c grub-install -s d -l directory -d 'use images and modules under DIR [default=/nix/store/wwwcg70bqwij1iygmg8vpn8d…'
...
complete -c grub-install -l locale-directory -d '[default=/nix/store/wwwcg70bqwij1iygmg8vpn8d6zadrrlq-grub-2. 12/share/locale]'
