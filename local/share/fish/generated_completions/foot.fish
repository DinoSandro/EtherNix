# foot
# Autogenerated from man page /run/current-system/sw/share/man/man1/foot.1.gz
...
complete -c foot -l pty -d 'Display an existing pty instead of creating one.  This is useful'
