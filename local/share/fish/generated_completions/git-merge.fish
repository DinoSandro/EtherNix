# git-merge
# Autogenerated from man page /run/current-system/sw/share/man/man1/git-merge.1.gz
...
complete -c git-merge -l ignore-cr-at-eol -d 'oc o 2'
complete -c git-merge -l find-renames -d 'rename-threshold=<n> Deprecated synonym for find-renames=<n>'
complete -c git-merge -l diff-algorithm -d 'ort specifically uses diff-algorithm=histogram, while recursive defaults to t…'
complete -c git-merge -l no-renames -d 'resolve This can only resolve two heads (i. e'
