# git-pull
# Autogenerated from man page /run/current-system/sw/share/man/man1/git-pull.1.gz
...
complete -c git-pull -l ignore-cr-at-eol -d 'oc o 2'
complete -c git-pull -l find-renames -d 'rename-threshold=<n> Deprecated synonym for find-renames=<n>'
complete -c git-pull -l diff-algorithm -d 'ort specifically uses diff-algorithm=histogram, while recursive defaults to t…'
complete -c git-pull -l no-renames -d 'resolve This can only resolve two heads (i. e'
