# git-rebase
# Autogenerated from man page /run/current-system/sw/share/man/man1/git-rebase.1.gz
...
complete -c git-rebase -l ignore-cr-at-eol -d 'oc o 2'
complete -c git-rebase -l find-renames -d 'rename-threshold=<n> Deprecated synonym for find-renames=<n>'
complete -c git-rebase -l diff-algorithm -d 'ort specifically uses diff-algorithm=histogram, while recursive defaults to t…'
complete -c git-rebase -l no-renames -d 'resolve This can only resolve two heads (i. e'
