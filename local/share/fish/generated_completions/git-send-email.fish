# git-send-email
# Autogenerated from man page /run/current-system/sw/share/man/man1/git-send-email.1.gz
...
complete -c git-send-email -l suppress-cc -d 'Specify an additional category of recipients to suppress the auto-cc of:   '
