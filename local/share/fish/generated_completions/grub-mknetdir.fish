# grub-mknetdir
# Autogenerated from man page /run/current-system/sw/share/man/man1/grub-mknetdir.1.gz
...
complete -c grub-mknetdir -s d -l directory -d 'use images and modules under DIR [default=/nix/store/wwwcg70bqwij1iygmg8vpn8d…'
...
complete -c grub-mknetdir -l locale-directory -d '[default=/nix/store/wwwcg70bqwij1iygmg8vpn8d6zadrrlq-grub-2. 12/share/locale]'
