# grub-mkrescue
# Autogenerated from man page /run/current-system/sw/share/man/man1/grub-mkrescue.1.gz
...
complete -c grub-mkrescue -s d -l directory -d 'use images and modules under DIR [default=/nix/store/wwwcg70bqwij1iygmg8vpn8d…'
...
complete -c grub-mkrescue -l locale-directory -d '[default=/nix/store/wwwcg70bqwij1iygmg8vpn8d6zadrrlq-grub-2. 12/share/locale]'
