# git-worktree
# Autogenerated from man page /run/current-system/sw/share/man/man1/git-worktree.1.gz
...
complete -c git-worktree -o f/--force -d 'list List details of each worktree'
