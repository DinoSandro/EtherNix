# git-rev-list
# Autogenerated from man page /run/current-system/sw/share/man/man1/git-rev-list.1.gz
...
complete -c git-rev-list -l 'objects*;' -d '<filter-spec> may be one of the following: The form'
...
complete -c git-rev-list -l no-abbrev -d 'oc o 2'
