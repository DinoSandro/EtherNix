# git-name-rev
# Autogenerated from man page /run/current-system/sw/share/man/man1/git-name-rev.1.gz
...
complete -c git-name-rev -l stdin -d 'in older versions of Git.  For example: $ cat sample. txt'
