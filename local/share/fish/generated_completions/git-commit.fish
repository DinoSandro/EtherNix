# git-commit
# Autogenerated from man page /run/current-system/sw/share/man/man1/git-commit.1.gz
...
complete -c git-commit -l cleanup -d 'This option determines how the supplied commit message should be cleaned up b…'
