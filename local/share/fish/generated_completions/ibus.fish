# ibus
# Autogenerated from man page /run/current-system/sw/share/man/man1/ibus.1.gz
complete -c ibus -l type -d 'is given, It tries to restart via systemd only.  If'
complete -c ibus -l xim -d '& GNOME desktop runs ibus-daemon via systemd and other desktops run ibus-daem…'
