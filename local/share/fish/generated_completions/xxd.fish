# xxd
# Autogenerated from man page /run/current-system/sw/share/man/man1/xxd.1.gz
...
complete -c xxd -s d -d 'show offset in decimal instead of hex'
...
complete -c xxd -s R -d 'In the output the hex-value and the value are both colored with the same colo…'
