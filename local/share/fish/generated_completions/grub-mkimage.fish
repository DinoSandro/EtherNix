# grub-mkimage
# Autogenerated from man page /run/current-system/sw/share/man/man1/grub-mkimage.1.gz
...
complete -c grub-mkimage -s d -l directory -d 'use images and modules under DIR [default=/nix/store/wwwcg70bqwij1iygmg8vpn8d…'
