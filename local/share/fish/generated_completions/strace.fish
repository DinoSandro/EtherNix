...
complete -c strace -l kill-on-exit -d 'Apply  PTRACE_O_EXITKILL ptrace option to all tracee processes (which sends a…'
...
complete -c strace -l always-show-pid -d 'Show PID prefix also for the process started by strace'
